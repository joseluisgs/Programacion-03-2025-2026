...
#### 13.1. Declaración e Inicialización de Estructuras
...
Si deseas modificar la estructura original dentro de una función o procedimiento, puedes pasarla por referencia utilizando la palabra clave `ref` o `out`.
